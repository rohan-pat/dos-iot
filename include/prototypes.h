...
extern uint32 is_low(uint32, uint32);
extern uint32 GPIO_set_dir(int32, uint32, uint32);
extern void GPIO_high(uint32, uint32);
extern void GPIO_low(uint32, uint32);
extern uint32 GPIO_read(uint32, uint32);
extern void adc_init();
extern uint32 analogRead(uint32);
